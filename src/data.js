...
// bent 决定这家抢什么案子：all 通吃偏大案 / lit 诉讼 / cheap 低价抢小案 /
// corp 跨境并购 / picky 只挑贵的 / gov 政府国企
const RIVAL_DEFS=[
  ['恒泰律师事务所','老牌红圈所，什么都接，报价也最高',9,'all'],
  ['京衡诉讼团队','只做诉讼，庭上出了名的难缠',7,'lit'],
  ['汇通法律服务','低价走量，小案抢得最凶',5,'cheap'],
  ['远东（中国）办公室','外所中国办公室，专啃跨境并购',8,'corp'],
  ['执一律师事务所','新锐精品所，挑案子挑客户',6,'picky'],
  ['广源律师事务所','关系型，政府和国企项目吃得开',7,'gov']
];
...
const RISK_DECAY=3,RISK_DECAY_WEEKS=11;
